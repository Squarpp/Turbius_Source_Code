...
namespace VHS
{
    ...
    {
        [SerializeField] public LayerMask excludeRoof; //agregado por VSO
        ...
        #region VSOWasHere
        [Space, Header("V.S.O Games Was Here")]
        [SerializeField] public bool chase = false;
        [SerializeField] private Animator animVolumeChase; //soy boludo
        [SerializeField] private Animator animCam; //el metodo PAPU
        #endregion
        ...
        protected virtual void Update()
        {
            ...
            anim.SetFloat("velocity", m_currentSpeed);

            //el metodo paraguayo
            animCam.SetBool("chase", chase);
            animVolumeChase.SetBool("chase", chase); 
            
            if (chase)
            {
                headBobData.xAmplitude = 0.1f;
                headBobData.yAmplitude = 0.2f;
            }
            else
            {
                headBobData.xAmplitude = 0.05f;
                headBobData.yAmplitude = 0.1f;
            }
            //termino el metodo paraguayo
        ...
        #region Custom Methods
            ...
            bool _hitRoof = Physics.SphereCast(_origin, raySphereRadius, Vector3.up, out _roofInfo, m_initHeight, ~excludeRoof);
     ...
     //           }
                ...
                public void temporalScare()
                   {
                        StartCoroutine(tempScare());
                   }

                public IEnumerator tempScare()
                 {
                   chase = true;
